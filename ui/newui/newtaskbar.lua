...
NewTaskbar = {
	...
	----------------------------- Left Side Handy Buttons --------------------------
	{
		...
		},
		{
			...
			{
				type = "ButtonHD",
				name = "mk_btnConsoleWindow",
				toggleButton = 1,
				ignored = 1,
				buttonStyle = "RM_TaskbarHD_CommandButtonToggleStyle",
				onMouseClicked = "UI_ToggleScreen('MK_ConsoleScreen', ePopup)",
				helpTip = "Console Window",
				helpTipTextLabel = "commandsHelpTip",
				hotKeyID = 140,
				soundOnClicked = "SFX_ButtonClick",
			...
			-- dup. for balance screen if developer cmd flag not set
			{
				type = "ButtonHD",
				name = "btnSpawner",
				toggleButton = 1,
				...
				buttonStyle = "RM_TaskbarHD_CommandButtonToggleStyle",
				--name = "btnWaypoint",
				onMouseClicked = "UI_ToggleScreen( 'SpawnerScreen', 0)",
				helpTip = "Spawner Window",
				soundOnClicked = "SFX_ButtonClick",
